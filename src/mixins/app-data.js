  ...
  computed: {
    appData () {
      return {
        title: 'Laniakea',
        socialLinks: [
          { name: 'Facebook', icon: 'mdi-facebook', link: 'https://facebook.com/untaltioyt', color: '#0F98F6' },
          { name: 'Twitter', icon: 'mdi-twitter', link: 'https://twitter.com/alcinos_', color: '#1A91DA' },
          { name: 'Twitch', icon: 'mdi-twitch', link: 'https://twitch.tv/untaltioyt', color: '#9147FF' },
        ],
        contact: {
